...
function SignUp(props: Props) {
    ...
    async function handleSubmit(event: any): Promise<void> {
        ...
        try {
            ...
            firebaseSignUp = await createUserWithEmailAndPassword(
                auth,
                email,
                passwordInput
            );
        ...
        <article className='signUpContainer'>
            <section className='formWrapper'>
                <form className='form' onSubmit={handleSubmit}>
                    ...
                    <input
                        data-e2e='signup-password-input'
                        className={
                    ...
                    {isPasswordValid === false && (
                        <p
                            data-e2e='signup-required-password-format-message'
                            className='w-56 mt-1 text-left text-red-400 text-xs'
                        >
                            * Password must have:
                            <br />
                    ...
                    <input
                        data-e2e='signup-confirm-password-input'
                        className={
                            passwordMatch
                                ? 'formPassword'
                                : 'formPasswordIncorrect'
                    ...
                    {passwordMatch === false && (
                        <p
                            data-e2e='signup-passwords-must-match-message'
                            className='w-56 mt-1 text-left text-red-400 text-xs'
                        >
                    ...
                    {registration === 'emailExists' && (
                        <p
                            data-e2e='signup-email-already-exists-message'
                            className='w-56 mt-1 text-left text-red-400 text-xs'
                        >
                            * Account with this email address <br /> &nbsp;
                            already exists
                        </p>
                    )}
                    {registration === 'registeredNotVerified' && (
                        <p
                            data-e2e='signup-success-message'
                            className='w-56 mt-1 text-left text-green-400 text-xs'
                        >
                            * Account created. Please check your <br /> &nbsp;
                            email to verify your account
                        </p>
                    )}

                    <input
                        data-e2e='signup-submit-button'
                        type='submit'
